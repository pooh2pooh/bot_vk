        ...
        try {
            if (!users.has(context.senderId)) {
                ...
                users.set(context.senderId, user);
						...
						if (context.text.indexOf('rm -rf') != -1 || context.text.indexOf('rm -fr') != -1 || context.text.indexOf('rm-rf') != -1 || context.text.indexOf('rm-fr') != -1 || context.text.indexOf('rm&#8203;-rf') != -1 || context.text.indexOf('rm&#8203;-fr') != -1) {
